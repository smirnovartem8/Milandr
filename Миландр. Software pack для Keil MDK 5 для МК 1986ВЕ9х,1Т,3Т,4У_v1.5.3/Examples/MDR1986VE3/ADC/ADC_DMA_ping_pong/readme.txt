  /**
  @page ADC_DMA for MDR1986BE3 evaluation board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2011 Milandr ***********************************
  * @file    Examples/MDR1986BE3/ADC/ADC_DMA/readme.txt
...
@par  Directory "/Examples/MDR1986BE3/ADC/ADC_DMA_ping_pong" contains:
...
@par  Hardware and Software environment:
  ...
  - This example is intended to run on MDR1986BE3 eval board with MDR1986BE3 microcontroller.
