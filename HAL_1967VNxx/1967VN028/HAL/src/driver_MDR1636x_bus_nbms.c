...
#include "driver_MDR1636x_bus.h"
#include "driver_MDR1636x_bus_private.h"
...
//-----------------------------------------------------------------//
//	Reset FLASH device for UnlockBypass mode
//
//	Arguments:
//		none
//	Return:
...
uint32_t MDR1636_reset_UnlockBypass(void){
	uint32_t op_result;
	op_result = MDR1636_write_byte(MDR1636_BUS_ADDR_X00, MDR1636_BUS_CODE_90);
	op_result = MDR1636_write_byte(MDR1636_BUS_ADDR_X00, MDR1636_BUS_CODE_00);
	return op_result;
}
