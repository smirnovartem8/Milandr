/**
  ******************************************************************************
  * @file    MDR32F2C10_usb_device.h
  * @author  Milandr Application Team
  * @version V1.0.1
  * @date    11/11/2020
  * @brief   USB Library device header file.
  ******************************************************************************
  * <br><br>
...
#ifndef __MDR32F2C10_USB_DEVICE_H
#define __MDR32F2C10_USB_DEVICE_H
...
typedef USB_Result (*USB_EP_Setup_Handler)( USB_EP_TypeDef EPx,
...
#endif /* __MDR32F2C10_USB_DEVICE_H */

/******************* (C) COPYRIGHT 2020 Milandr *********/

/* END OF FILE MDR32F2C10_usb_device.h */
