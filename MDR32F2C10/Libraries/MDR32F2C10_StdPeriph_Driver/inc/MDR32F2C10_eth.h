...
#ifndef __MDR32F2C10_ETH_H_
#define __MDR32F2C10_ETH_H_
...
typedef struct {
	...
	FunctionalState		ETH_DBG_RF;							/*!< Enable or disable automatic change of the receiver FIFO pointers.
 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 This parameter can be: ENABLE or DISABLE. */
    uint32_t            ETH_SPEED;                          /*!< Select interface speed.
                                                                 This parameter can be:  */ 
    BitStatus           ETH_RMII_nMII;                      /*!< Select interface mode.
...
#define ETH_BUFF_BASE_ADDR             0x21008000UL
...
#define ETH_DBG_MODE_FREE_RUN			(uint32_t)(0x0 << ETH_G_CFG_DBG_MODE_Pos)
#define ETH_DBG_MODE_HALT				(uint32_t)(0x2 << ETH_G_CFG_DBG_MODE_Pos)
#define ETH_DBG_MODE_STOP				(uint32_t)(0x3 << ETH_G_CFG_DBG_MODE_Pos)

#define IS_ETH_DBG_MODE(MODE)			((MODE == ETH_DBG_MODE_FREE_RUN) |\
										 (MODE == ETH_DBG_MODE_HALT) |\
										 (MODE == ETH_DBG_MODE_STOP))

/** @} */ /* End of group ETH_DBG_MODE */

/** @defgroup ETH_SPEED ETH_SPEED
  * @{
  */

#define ETH_SPEED_10			       (uint32_t)(0x0 << ETH_G_CFG_RMII_SPEED_Pos)
#define ETH_SPEED_100				   (uint32_t)(0x1 << ETH_G_CFG_RMII_SPEED_Pos)


#define IS_ETH_SPEED(MODE)			   ((MODE == ETH_SPEED_10) |\
										(MODE == ETH_SPEED_100))

/** @} */ /* End of group ETH_SPEED */

/** @defgroup ETH_BUFFER_MODE ETH_BUFFER_MODE
  * @{
  */

#define ETH_BUFFER_MODE_LINEAR						(uint32_t) (0x0 << ETH_G_CFG_BUFF_MODE_Pos)
#define ETH_BUFFER_MODE_AUTOMATIC_CHANGE_POINTERS	(uint32_t) (0x1 << ETH_G_CFG_BUFF_MODE_Pos)
#define ETH_BUFFER_MODE_FIFO						(uint32_t) (0x2 << ETH_G_CFG_BUFF_MODE_Pos)
...
/** @} */ /* End of group ETH_TRANSMITTER_BE */
...
/** @defgroup ETH_RECEIVER_BE ETH_RECEIVER_BE
  * @{
  */
...
/** @} */ /* End of group ETH_RECEIVER_BE */

/** @defgroup ETH_RECEIVER_BITS_ORDER ETH_RECEIVER_BITS_ORDER
  * @{
  */
...
/** @} */ /* End of group ETH_RECEIVER_BITS_ORDER */
...
#define IS_ETH_CLOCK_BRG(BRG)              (((BRG) >= 0) && ((BRG) <= 65535))
...
#endif /* __MDR32F2C10_ETH_H_ */

/******************* (C) COPYRIGHT 2020 Milandr *********
*
* END OF FILE MDR32F2C10_eth.h */
