...
#ifndef __MDR32F2C10_UART_H
#define __MDR32F2C10_UART_H
...
#define UART_IT_TBSY                        ((uint32_t)0x00002000)
#define UART_IT_TFE                         ((uint32_t)0x00001000)
#define UART_IT_RNE                         ((uint32_t)0x00000800)
...
#define IS_UART_CONFIG_IT(IT)               (((IT) == UART_IT_TBSY) || ((IT) == UART_IT_TFE) || \
                                            ((IT) == UART_IT_RNE)   || ((IT) == UART_IT_OE)  || \
                                            ((IT) == UART_IT_BE)    || ((IT) == UART_IT_PE)  || \
                                            ((IT) == UART_IT_FE)    || ((IT) == UART_IT_RT)  || \
                                            ((IT) == UART_IT_TX)    || ((IT) == UART_IT_RX)  || \
                                            ((IT) == UART_IT_DSR)   || ((IT) == UART_IT_DCD) || \
                                            ((IT) == UART_IT_CTS)   || ((IT) == UART_IT_RI))
...
void UART_BRGInit(MDR_UART_TypeDef* UARTx, uint16_t UART_BRG, uint32_t UART_CLK_SOURSE);
...
#endif /* __MDR32F2C10_UART_H */

/******************* (C) COPYRIGHT 2020 Milandr ********************************
*
* END OF FILE MDR32F2C10_uart.h */
