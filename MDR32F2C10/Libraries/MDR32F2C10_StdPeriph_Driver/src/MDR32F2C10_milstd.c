...
/* Includes ------------------------------------------------------------------*/
#include "MDR32F2C10_milstd.h"

#define ASSERT_INFO_FILE_ID FILEID__MDR32F2C10_MIL_STD1553_C
...
/**
  * @brief  Initializes the both MIL_STD_1553 peripheral Clock according to the
  *         specified parameters.
  * @param  MIL_STD_1553_CLK_DIV: specifies the MAX_CLK division factor.
  * @retval None
  */
void MIL_STD_1553_CLK_en(uint32_t MIL_STD_1553_CLK_DIV)
{
    uint32_t tmpreg;
...
//	ptr_data = (uint32_t *)((uint32_t)MIL_STD_1553x + sizeof(uint32_t)*Subaddress*32);
    ptr_data = (uint32_t *)&MIL_STD_1553x->DATA[ /*sizeof(uint32_t)**/Subaddress*32 ];
...
*
* END OF FILE MDR32F2C10_milstd.c */
