...
//													 	 	 	 This parameter can be a value of @ref ETH_PHY_INTERFACE. */
	FunctionalState			ETH_PHY_LB;
	
	FunctionalState			ETH_PHY_DLB;
	
	FunctionalState			ETH_PHY_HALFD;

	FunctionalState			ETH_PHY_EARLY_DV;	
	
	uint32_t			ETH_PHY_DIR;	
	
	uint32_t			ETH_PHY_BASE_2;		
	
	uint32_t			ETH_PHY_LINK_PERIOD;	
	
	uint32_t			ETH_PHY_EXT_EN;		
	
	uint32_t			ETH_PHY_A_SELR;		
	
	uint32_t			ETH_PHY_A_TRIM;	
	
	uint32_t			ETH_PHY_A_TRIMR;
...
#define ETH_PHY_CONTROL_DIR_DIRECT							(uint32_t)(0x00 << ETH_PHY_CONTROL_DIR_pos)
#define ETH_PHY_CONTROL_DIR_INVERSE							(uint32_t)(0x01 << ETH_PHY_CONTROL_DIR_pos)

#define ETH_PHY_CONTROL_BASE_2_TWISTED					(uint32_t)(0x00 << ETH_PHY_CONTROL_BASE_2_pos)
#define ETH_PHY_CONTROL_BASE_2_COAXIAL					(uint32_t)(0x01 << ETH_PHY_CONTROL_BASE_2_pos)

#define ETH_PHY_CONTROL_EXT_EN_INTER						(uint32_t)(0x00 << ETH_PHY_CONTROL_EXT_EN_pos)
#define ETH_PHY_CONTROL_EXT_EN_EXTER						(uint32_t)(0x01 << ETH_PHY_CONTROL_EXT_EN_pos)

#define ETH_PHY_CONTROL_A_SELR_INTER						(uint32_t)(0x00 << ETH_PHY_CONTROL_A_SELR_pos)
#define ETH_PHY_CONTROL_A_SELR_EXTER						(uint32_t)(0x01 << ETH_PHY_CONTROL_A_SELR_pos)

#define ETH_PHY_CONTROL_A_TRIM_MAXV							(uint32_t)(0x00 << ETH_PHY_CONTROL_A_TRIM_pos)
#define ETH_PHY_CONTROL_A_TRIM_MINV							(uint32_t)(0x07 << ETH_PHY_CONTROL_A_TRIM_pos)

#define ETH_PHY_CONTROL_A_TRIMR_TYPC						(uint32_t)(0x80 << ETH_PHY_CONTROL_A_TRIMR_pos)
#define ETH_PHY_CONTROL_A_TRIMR_MINC						(uint32_t)(0x00 << ETH_PHY_CONTROL_A_TRIMR_pos)
#define ETH_PHY_CONTROL_A_TRIMR_MAXC						(uint32_t)(0xFF << ETH_PHY_CONTROL_A_TRIMR_pos)
...
#define ETH_RECEIVER_BITS_ORDER_MSB	(uint32_t)(1 << ETH_R_CFG_MSB1st_Pos)
...
#define ETH_PHY_CLOCK_SOURCE_HSE0			(uint32_t)(0x00000001)
#define ETH_PHY_CLOCK_SOURCE_PLL0		  (uint32_t)(0x00000005)<<28
#define ETH_PHY_CLOCK_SOURCE_HSE1			(uint32_t)(0x30000002)

#define IS_ETH_CLOCK_SOURCE(CLOCK_SOURCE)		((CLOCK_SOURCE == ETH_PHY_CLOCK_SOURCE_HSI) |\
												 (CLOCK_SOURCE == ETH_PHY_CLOCK_SOURCE_HSE0) |\
												 (CLOCK_SOURCE == ETH_PHY_CLOCK_SOURCE_PLL0) |\
												 (CLOCK_SOURCE == ETH_PHY_CLOCK_SOURCE_HSE1))
...
FlagStatus ETH_GetMACITStatus(MDR_ETH_TypeDef * ETHERNETx, uint32_t ETH_MAC_FLAG);
...
void ETH_GetMACAddress(MDR_ETH_TypeDef * ETHERNETx, uint16_t *Addr);
